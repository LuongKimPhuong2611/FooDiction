  ...
  return (
    <div className="container">
      ...
      <div className="content-tabs">
        ...
        >
         {(props.listIngredient.length>0) ? <ListIngredient ingredients={props.listIngredient} />: <h2 className="No-result">No ingredient can find</h2>}
        </div>

        <div
          className={toggleState === 2 ? "content  active-content" : "content"}
        >
          {(props.listRecipe.length>0) ? <ListRecipe recipes={props.listRecipe} />: <h2 className="No-result">No recipe can find</h2>}
        </div>
      </div>
    </div>
  );
